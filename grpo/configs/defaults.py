...
@dataclass
class PathConfig:
    train_data_file: str = "/home/aayush/DATA/GRPO/train.jsonl"           # jsonl file containing the training data
    val_data_file: str = "/home/aayush/DATA/GRPO/validation.jsonl"        # jsonl file containing the validation data
    prompt_template_file: str = "/home/aayush/DATA/GRPO/r1_zero.prompt"   # prompt template file
    model_path: str = "/home/aayush/DATA/Qwen2.5-Math-1.5B"               # path to the qwen2.5-math-1.5b model checkpoint
    output_dir: str = "/home/aayush/RESULTS/GRPO/run"                     # directory to save the results
